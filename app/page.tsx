...
import { ArrowRight, GraduationCap, Download, Shield, Clock } from "lucide-react"
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800">
      ...
      <main className="relative">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute top-10 -left-10 w-32 h-32 sm:top-20 sm:-left-20 sm:w-40 sm:h-40 md:w-60 md:h-60 lg:top-40 lg:-left-40 lg:w-80 lg:h-80 bg-purple-500/20 rounded-full blur-xl sm:blur-2xl lg:blur-3xl"></div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 pt-6 pb-12 sm:px-6 sm:pt-12 sm:pb-20 md:pt-16 md:pb-24 lg:pt-20 lg:pb-32">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl text-slate-300 mb-6 sm:mb-8 md:mb-12 max-w-3xl mx-auto leading-relaxed px-4 animate-in fade-in slide-in-from-bottom-3 duration-700 delay-400">
              Download your Visvesvaraya Technological University examination results in PDF or CSV format. Fast,
              secure, and always up-to-date.
            </p>

            {/* CTA Buttons - Enhanced Responsive Layout */}
            <div className="flex flex-col gap-2.5 justify-center mb-8 sm:mb-12 md:mb-16 px-4 sm:flex-row sm:gap-4 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-500">
              <Link href="/portal" className="w-full sm:w-auto">
                <Button
                  size="lg"
                  className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white px-4 py-2.5 sm:px-6 sm:py-3 md:px-8 md:py-4 text-sm sm:text-base md:text-lg font-semibold rounded-lg sm:rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 group min-h-[44px] touch-manipulation hover:scale-105 active:scale-95"
                >
                  Get Your Results
              ...
              <Button
                variant="outline"
                size="lg"
                className="w-full sm:w-auto border-slate-600 text-slate-300 hover:bg-slate-800 px-4 py-2.5 sm:px-6 sm:py-3 md:px-8 md:py-4 text-sm sm:text-base md:text-lg font-semibold rounded-lg sm:rounded-xl bg-transparent min-h-[44px] touch-manipulation hover:scale-105 active:scale-95 transition-all duration-300"
              >
                Learn More
              </Button>
            </div>

            {/* Stats - Enhanced Grid Layout */}
            <div className="grid grid-cols-3 gap-3 sm:gap-6 md:gap-8 max-w-2xl sm:max-w-3xl mx-auto px-4 animate-in fade-in slide-in-from-bottom-3 duration-700 delay-600">
              <div className="text-center group hover:scale-105 transition-transform duration-300">
                <div className="text-lg sm:text-2xl md:text-3xl font-bold text-white mb-0.5 sm:mb-1 md:mb-2">10K+</div>
                <div className="text-xs sm:text-sm md:text-base text-slate-400">Results Downloaded</div>
              </div>
              <div className="text-center group hover:scale-105 transition-transform duration-300">
                <div className="text-lg sm:text-2xl md:text-3xl font-bold text-white mb-0.5 sm:mb-1 md:mb-2">99.9%</div>
                <div className="text-xs sm:text-sm md:text-base text-slate-400">Uptime</div>
              </div>
              <div className="text-center group hover:scale-105 transition-transform duration-300">
                <div className="text-lg sm:text-2xl md:text-3xl font-bold text-white mb-0.5 sm:mb-1 md:mb-2">24/7</div>
                <div className="text-xs sm:text-sm md:text-base text-slate-400">Available</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 gap-3 sm:gap-4 md:gap-6 lg:grid-cols-3 lg:gap-8">
          <Card className="bg-slate-800/50 border-slate-700 backdrop-blur-sm touch-manipulation hover:bg-slate-800/70 transition-all duration-300 hover:scale-105 hover:shadow-xl animate-in fade-in slide-in-from-bottom-4 duration-700 delay-700 group">
            <CardContent className="p-3 sm:p-4 md:p-6 text-center">
              <div className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 bg-blue-500/20 rounded-lg flex items-center justify-center mx-auto mb-2 sm:mb-3 md:mb-4 group-hover:bg-blue-500/30 transition-colors duration-300 group-hover:scale-110">
                <Download className="h-4 w-4 sm:h-5 sm:w-5 md:h-6 md:w-6 text-blue-400 group-hover:text-blue-300 transition-colors duration-300" />
              </div>
              <h3 className="text-base sm:text-lg md:text-xl font-semibold text-white mb-1 sm:mb-2 group-hover:text-blue-300 transition-colors duration-300">
                Multiple Formats
              </h3>
              <p className="text-xs sm:text-sm md:text-base text-slate-400 group-hover:text-slate-300 transition-colors duration-300">
                Download your results in PDF or CSV format for easy viewing and analysis.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-slate-800/50 border-slate-700 backdrop-blur-sm touch-manipulation hover:bg-slate-800/70 transition-all duration-300 hover:scale-105 hover:shadow-xl animate-in fade-in slide-in-from-bottom-4 duration-700 delay-800 group">
            <CardContent className="p-3 sm:p-4 md:p-6 text-center">
              <div className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 bg-green-500/20 rounded-lg flex items-center justify-center mx-auto mb-2 sm:mb-3 md:mb-4 group-hover:bg-green-500/30 transition-colors duration-300 group-hover:scale-110">
                <Shield className="h-4 w-4 sm:h-5 sm:w-5 md:h-6 md:w-6 text-green-400 group-hover:text-green-300 transition-colors duration-300" />
              </div>
              <h3 className="text-base sm:text-lg md:text-xl font-semibold text-white mb-1 sm:mb-2 group-hover:text-green-300 transition-colors duration-300">
                Secure Access
              </h3>
              <p className="text-xs sm:text-sm md:text-base text-slate-400 group-hover:text-slate-300 transition-colors duration-300">
          ...
          <Card className="bg-slate-800/50 border-slate-700 backdrop-blur-sm touch-manipulation hover:bg-slate-800/70 transition-all duration-300 hover:scale-105 hover:shadow-xl animate-in fade-in slide-in-from-bottom-4 duration-700 delay-900 group lg:col-span-1">
            <CardContent className="p-3 sm:p-4 md:p-6 text-center">
              ...
              <h3 className="text-base sm:text-lg md:text-xl font-semibold text-white mb-1 sm:mb-2 group-hover:text-purple-300 transition-colors duration-300">
                Real-time Updates
              </h3>
              <p className="text-xs sm:text-sm md:text-base text-slate-400 group-hover:text-slate-300 transition-colors duration-300">
                Get the latest results as soon as they're published by the university.
              </p>
            </CardContent>
          </Card>
        </div>
